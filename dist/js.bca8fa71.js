...
},{"_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"../node_modules/promise-polyfill/src/finally.js":[function(require,module,exports) {
"use strict";
...
exports.default = {
  ...
  fillPolifyll: function fillPolifyll() {
...
var BeerCanvas = function () {
  function BeerCanvas() {
    var _this = this;

    var id = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'beerCanvas';

    _classCallCheck(this, BeerCanvas);

    this.canvas = document.getElementById(id);
    this.ctx = this.canvas.getContext('2d');
    this.particles = Array(280).fill().map(function (_) {
      return new particle(_this.canvas);
    });
  ...
  _createClass(BeerCanvas, [{
    ...
    value: function draw() {
      ...
      this.particles.forEach(function (p) {
        ...
        _this2.ctx.fillStyle = 'rgba(255,255,255,' + p.opacity + ')';
...
var _beerCanvas = require('./components/beerCanvas');

var _beerCanvas2 = _interopRequireDefault(_beerCanvas);
...
//# sourceMappingURL=/js.bca8fa71.map